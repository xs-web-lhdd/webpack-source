		...
		compiler.hooks.thisCompilation.tap("SplitChunksPlugin", compilation => {
			...
			compilation.hooks.optimizeChunks.tap(
				...
				chunks => {
					...
					// 遍历所有模块，构建出chunksInfoMap数据
					// 遍历compilation.modules,根据cacheGroup形成chunksInfoMap数据
					logger.time("modules");
					...
					// 根据minSize进行chunk的分包处理，以及遍历chunksInfoMap数据
					logger.time("queue");
